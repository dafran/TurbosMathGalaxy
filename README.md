...
- **🐾 Compañeros desbloqueables, cada uno con su potenciador:** al avanzar, el niño desbloquea **nuevos personajes que reemplazan a Turbo si él quiere** — **🐱 Michi** (gatita, a los 12 niveles), **🐕 Bruno** (perro negro despeinado, a los 30) y **🦊 Rita** (zorra rastreadora, a los 50). El niño **elige** a quién ver como su acompañante; es una preferencia, nunca una obligación, y funciona igual en el modo de los más pequeños ("Mi compañero"). Cada uno aporta además un **potenciador propio en cada camino**:

  | | Aventurero | Pequeño explorador |
  |---|---|---|
  | 🐶 Turbo | A veces evita perder un corazón | 🤗 Te consuela cuando algo sale mal |
  | 🐱 Michi | Congela el reloj más seguido | 🧩 Trae juegos sorpresa más seguido |
  | 🐕 Bruno | Una moneda extra por acierto | 🎉 Celebra tus rachas desde la segunda |
  | 🦊 Rita | Más cofres y más objetos | 🎁 Te encuentra calcomanías de regalo |

  Los del aventurero son mecánicos (vidas, reloj, monedas, objetos); los del pequeño son de **acompañamiento**, porque su camino no tiene nada de eso. Cada selector anuncia solo el potenciador que de verdad aplica en su camino. Y la presencia emocional base (rachas celebradas, ánimo tras un error) la tienen **todos** por igual: el potenciador solo suma, nunca resta.
...
- **👾 Enemigos menores variados:** 24 secuaces con **aguante propio** (de 2 a 5 aciertos) que aparecen en orden distinto en cada nivel, además de los **jefes** de fin de mundo.
...
- **🎭 Jefes con retrato propio:** los once jefes son **personajes originales dibujados en SVG** — Doctor Tornillo, Caballero resta, Dragón de Obsidiana, Lord Eclipse, Acero Veloz, Profesor Cascarón, El Tricalavera, Chispa Oscura, Emperador de Hierro, Maestro del tiempo y Sabio galáctico. Antes eran emoji, y el nombre prometía un personaje que el dibujo no daba: el señor oscuro salía como 🌑, que es una luna.
- **🎉 Mensajes de racha:** al encadenar **3, 5 o 7 respuestas seguidas**, aparece un mensaje saltón que **celebra el esfuerzo** ("¡3 seguidas!", "¡Racha en fuego!"). Refuerzo positivo inmediato, al estilo de las apps de aprendizaje por rachas. Con **Bruno** como acompañante, en el camino del pequeño la celebración empieza en la segunda seguida, cuando la racha todavía se siente frágil.
...
- **📖 Álbum de stickers:** cada nivel superado regala un **sticker coleccionable** (animales, naves, planetas…) que se guardan en "Mi álbum". Si el acompañante es **Rita**, ella encuentra además **calcomanías de regalo** que viven en su propia sección del álbum — separadas de las de nivel, para que un regalo no parezca un nivel pendiente.
...
- **🎛️ Ajustes de experiencia para el papá:** desde "Para papás" se puede apagar por niño los **poderes del acompañante**, el **congelado del reloj**, los **minijuegos dentro del camino** y la **ronda sorpresa**. Vienen todos encendidos: no es una lista de cosas que activar, sino la posibilidad de quitar algo que a un niño concreto le estorbe.
...
| **El congelado del reloj es ocasional, no continuo** | Al encadenar aciertos, una pregunta llega sin reloj. La pregunta ya congelada **no cuenta** para el siguiente congelado, así que el premio cae cada 3-4 preguntas en vez de una de cada dos. | El tiempo se usa como **premio y nunca como castigo**, pero un premio que está siempre encendido deja de ser premio y el reloj deja de significar nada. Lo detectó un niño de 8 años jugando: notó que si seguía acertando el tiempo se quedaba congelado. | [3] |
| **Acompañante emocional** (camino del pequeño) | El compañero elegido consuela tras un error, celebra rachas antes, trae juegos sorpresa o regala calcomanías — según quién sea. Los regalos van en su **propia sección** del álbum, no mezclados con las calcomanías de nivel. | A esta edad el vínculo con un personaje sostiene la permanencia en la tarea mejor que una recompensa abstracta, y **la respuesta correcta al desánimo no es bajar la dificultad sino acompañar**: el mismo síntoma puede venir de cansancio o frustración, y ahí rebajar el reto no ayuda. Los regalos se separan del álbum de niveles a propósito: mezclarlos haría parecer que faltan niveles por superar, convirtiendo un regalo en una deuda. | [3][4] |
