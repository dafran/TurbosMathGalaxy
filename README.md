...
- **🐾 Compañeros desbloqueables, cada uno con su potenciador:** al avanzar, el niño desbloquea **nuevos personajes que reemplazan a Turbo si él quiere** — **🐱 Michi** (gatita, a los 12 niveles), **🐕 Bruno** (perro negro despeinado, a los 30) y **🦊 Rita** (zorra rastreadora, a los 50). El niño **elige** a quién ver como su acompañante; es una preferencia, nunca una obligación, y funciona igual en el modo de los más pequeños ("Mi compañero"). En el camino del aventurero cada uno aporta además un **potenciador**: Turbo a veces evita perder un corazón, Michi congela el reloj más seguido, Bruno da una moneda extra por acierto y Rita encuentra más cofres. (El camino del pequeño no tiene vidas, reloj ni monedas, así que allí los compañeros son solo compañía — y su selector no anuncia poderes que no ocurrirían.)
